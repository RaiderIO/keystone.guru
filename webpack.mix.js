...
// ---------------------------------------------------------------------------
// Generate per-locale language bundles to keep app.js small
// Each locale under /lang will output: public/js/lang-${locale}-${version}.js
// ---------------------------------------------------------------------------
try {
    ...
    if (fs.existsSync(langRoot)) {
        ...
        locales.forEach(locale => {
            ...
            const content = `// Auto-generated by webpack.mix.js — do not edit
...
// If Lang is available in window, initialize or update it
...
`;
            ...
            // Register Mix entry for this locale
            mix.js(`resources/assets/js/generated/lang/lang-${locale}.js`, `public/js/lang-${locale}-${version}.js`);
        });
    }
} catch (e) {
