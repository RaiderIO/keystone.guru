...
| Last full pass | 2026-08-21, #4165 — 24 catch-up keys (`view_creator.php`, `spellcounters.php`, `spellimmunities.php`, one `controller` key) on top of the 2026-08-20 pass (745 keys, 212 *Sie*→*du* normalised, 31 post-review rewrites). |
