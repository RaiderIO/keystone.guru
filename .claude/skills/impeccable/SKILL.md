---
name: impeccable
description: Design/redesign/critique/polish a frontend interface — visual hierarchy, accessibility, theming, typography, layout, motion, UX copy, design systems. User-triggered only via /impeccable; not for backend-only or non-UI tasks.
version: 4.0.4
user-invocable: true
