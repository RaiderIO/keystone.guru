...
history -s 'php artisan localization:exportnpcnames && php artisan localization:importnpcnames && php artisan localization:syncnpcnames retail && php artisan mapping:save'
