...
history -s 'php artisan localization:exportspellnames && php artisan localization:importspellnames && php artisan localization:syncspellnames retail && php artisan mapping:save && php artisan db:seed --database=migrate'
