...
namespace App\Http\Requests\Api\V1\CombatLog\EnemyResolution;
...
class CombatLogEnemyResolutionIndexRequest extends APIFormRequest
{
    ...
    /**
     * @return float|null Only resolutions at least this far off, judged on the same kill priority weighted distance the matcher used
     */
    public function getMinDistance(): ?float
    {
        $minDistance = $this->validated('min_distance');

        return $minDistance === null ? null : (float)$minDistance;
    }
