...
class DungeonRouteThumbnailJobResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'status'              => $this->status,
            'viewportWidth'       => $this->viewport_width ?? config('keystoneguru.api.dungeon_route.thumbnail.variants.standard.viewport_width'),
            'viewportHeight'      => $this->viewport_height ?? config('keystoneguru.api.dungeon_route.thumbnail.variants.standard.viewport_height'),
            'imageWidth'          => $this->image_width ?? config('keystoneguru.api.dungeon_route.thumbnail.variants.standard.image_width'),
            'imageHeight'         => $this->image_height ?? config('keystoneguru.api.dungeon_route.thumbnail.variants.standard.image_height'),
            'zoomLevel'           => $this->zoom_level ?? config('keystoneguru.api.dungeon_route.thumbnail.variants.standard.zoom_level'),
            'quality'             => $this->quality ?? config('keystoneguru.api.dungeon_route.thumbnail.variants.standard.quality'),
            'queueSize'           => $queueSize,
