...
class AdvancedDataBuilder
{
    public static function create(int $combatLogVersion): AdvancedDataInterface
    {
        return match ($combatLogVersion) {
            CombatLogVersion::CLASSIC, CombatLogVersion::CLASSIC_TBC_2_5_5 => new AdvancedDataV9(),
            CombatLogVersion::CLASSIC_SOD_1_15_5, CombatLogVersion::CLASSIC_SOD_1_15_6, CombatLogVersion::CLASSIC_SOD_1_15_7 => new AdvancedDataV9SoD(),
