...
class DamageSplitBuilder implements SpecialEventBuilderInterface
{
    ...
    public static function create(
        ...
        return match ($combatLogVersion) {
            CombatLogVersion::CLASSIC, CombatLogVersion::CLASSIC_SOD_1_15_5, CombatLogVersion::CLASSIC_SOD_1_15_6, CombatLogVersion::RETAIL_10_1_0, CombatLogVersion::RETAIL_11_0_2 => new DamageSplitV20($combatLogVersion, $timestamp, $eventName, $parameters, $rawEvent),
