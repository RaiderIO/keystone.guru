        ...
        $mappingVersionData    = $this->rememberLocal($mappingVersionDataKey, 86400, fn() => $this->cacheService->remember(
            ...
            function () {
                ...
                $dungeon = $this->dungeon
                    ->load([
                        'dungeonSpeedrunRequiredNpcs.dungeonSpeedrunRequiredNpcNpcs',
                    ])
                ...
                if ($this->mappingVersion->facade_enabled && $useFacade) {
                    foreach ($enemies as $enemy) {
                        ...
                        // actually lives on. Keep it around - it's the only way the front-end can tell
                        // which real floor a facade enemy belongs to.
                ...
                return array_merge(
                    ...
                    [
                        ...
                        'enemyForcesRegions'        => $this->mappingVersion->mapContextEnemyForcesRegions($this->coordinatesService, $useFacade),
