...
class IngameXY implements Arrayable
{
    ...
    public function getX(?int $precision = null): float
    {
        ...
        return $precision === null ? $this->x : round($this->x + 1e-9, $precision, \RoundingMode::HalfAwayFromZero); // @phpstan-ignore argument.type
    }
    ...
    {
        // Stabilize the float value by adding a very small number to it
        return $precision === null ? $this->y : round($this->y + 1e-9, $precision, \RoundingMode::HalfAwayFromZero); // @phpstan-ignore argument.type
    }
