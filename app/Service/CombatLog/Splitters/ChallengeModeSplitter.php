...
class ChallengeModeSplitter implements CombatLogSplitterInterface
{
    ...
    public function splitCombatLog(string $filePath): Collection
    {
        ...
        $this->combatLogService->parseCombatLog($filePath, fn($combatLogVersion, $rawEvent, $lineNr) => $this->parseCombatLogEvent($combatLogVersion, $rawEvent, $lineNr));
    ...
    private function parseCombatLogEvent(int $combatLogVersion, string $rawEvent, int $lineNr)
    {
        ...
        if ($this->lastChallengeModeStartEvent instanceof ChallengeModeStartEvent) {
            ...
            if ($parsedEvent instanceof ChallengeModeEndEvent) {
                $saveFilePath = $this->generateTargetCombatLogFileName();
...
// Always keep track of these events
     ...
     */
    private function generateTargetCombatLogFileName(): string
    {
