 ...
 * @method ChallengeModeRunData find(int $id, array $columns = [])
 * @method ChallengeModeRunData findOrFail(int $id, array $columns = [])
 * @method ChallengeModeRunData findOrNew(int $id, array $columns = [])
