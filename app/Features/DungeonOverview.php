...
class DungeonOverview
{
    ...
    public function resolve(?User $user): bool
    {
        ...
        // The dungeon overview links into the NPC compendium, so it may only go live once that has
        if (!Pennant::for($user)->active(NpcCompendium::class)) {
            return false;
        }
