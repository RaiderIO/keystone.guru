...
return [
    ...
    'edittabs' => [
        ...
        'members' => [
            ...
            'copy_to_clipboard_title'                    => 'Copia negli appunti',
            'refresh_invite_link_title'                  => 'Aggiorna il link di invito',
    ...
    'edit' => [
        ...
        'team_header'    => 'Team %s',
        'icon_image_alt' => 'Nessuna immagine',
        'routes'         => 'Percorsi',
        'members'        => 'Membri',
    ],
    'invite' => [
        ...
        'header'                      => 'Invito a unirsi al team %s',
        'invalid_team'                => 'Team non valido',
        'logo_image_alt'              => 'Logo del team',
        'already_a_member'            => 'Sei già un membro del team %s!',
        'invited_to_join'             => 'Sei stato invitato a unirti al team %s.',
        'accept_the_invitation'       => 'Accetta l\'invito per unirti al team!',
        'login_or_register_to_accept' => 'Accedi o registrati su Keystone.guru per unirti al team, è gratuito!',
        'return_to_team'              => 'Torna al team',
