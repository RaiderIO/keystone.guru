...
return [
    ...
    'custom_dungeon_mapping'             => 'Cartographie personnalisée des donjons',
    'custom_dungeon_mapping_description' => 'Keystone.guru a sa propre cartographie de donjons sans dépendances à aucun outil externe. Voyez quels ennemis renforcent les autres, lâchent l\'ichor sanguin ou explosent votre groupe. La cartographie est open source et gratuite. Toujours.',
    ...
    'feature_fluid_mapping_experience'             => 'Expérience de cartographie fluide',
    'feature_fluid_mapping_experience_description' => 'Propulsé par Leaflet, cartes de donjons améliorées par IA avec 5 niveaux de zoom et une interface utilisateur minimaliste pour vous offrir la meilleure expérience de cartographie possible.',
    'feature_mdt_import_export'                    => 'Importation/exportation MDT',
    'feature_mdt_import_export_description'        => 'Commencez facilement avec vos itinéraires existants et générez des chaînes MDT pour vos itinéraires existants afin que tout le monde soit à jour.',
    'feature_mobile_friendly'                      => 'Adapté aux mobiles',
    'feature_mobile_friendly_description'          => 'Visualisez ou modifiez vos itinéraires où que vous soyez sur votre téléphone ou tablette - rendant les pauses toilettes beaucoup plus intéressantes.',
    'features'                                     => 'Fonctionnalités',
    'get_organized'                                => 'Organisez-vous',
    'get_organized_description'                    => 'Organisez vos itinéraires depuis votre profil ou via des équipes. Keystone.guru vous offre une large gamme d\'outils pour garder tous vos itinéraires organisés et accessibles par tous les membres de votre équipe M+. Vous pouvez toujours exporter des itinéraires au format Mythic Dungeon Tools pour les partager avec d\'autres.',
