...
return [
    ...
    'bolstering' => [
        'name'        => 'Reforzante',
        'description' => 'Cuando muere cualquier enemigo que no sea un jefe, su grito de muerte empodera a los aliados cercanos, aumentando su salud máxima y daño en un 20%.',
    ],
    'bursting' => [
        'name'        => 'Explosivo',
    ...
    'explosive' => [
        'name'        => 'Explosivo',
        'description' => 'Mientras estás en combate, los enemigos periódicamente invocan Orbes Explosivos que detonarán si no son destruidos.',
    ],
    'fortified' => [
        'name'        => 'Fortificado',
        'description' => 'Los enemigos que no son jefes tienen un 20% más de salud e infligen hasta un 20% más de daño.',
    ],
    'grievous' => [
        'name'        => 'Grave',
    ...
    'spiteful' => [
        'name'        => 'Rencoroso',
        'description' => 'Los malvados se alzan de los cadáveres de los enemigos que no son jefes y persiguen a jugadores al azar.',
    ],
    'storming' => [
        'name'        => 'Tormentoso',
    ...
    'xalataths_bargain_ascendant' => [
        'name'        => 'Oferta de Xal\'atath: Ascendente',
        'description' => 'Mientras estás en combate, Xal\'atath hace llover orbes de energía cósmica que empoderan a enemigos o jugadores.',
    ],
    ...
    'xalataths_bargain_voidbound' => [
        ...
        'description' => 'Mientras estás en combate, Xal\'atath invoca a un emisario del vacío que potencia a los enemigos cercanos.',
    ],
    ...
    'lindormis_guidance' => [
        ...
        'description' => 'Lindormi guía a los jugadores, debilitando a enemigos no jefes seleccionados con Arenas Temporales y evitando que las muertes de los jugadores reduzcan el tiempo restante.',
    ],
