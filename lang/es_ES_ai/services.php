    ...
    'mdt' => [
        'io' => [
            ...
            'import_string' => [
                ...
                'unable_to_find_awakened_obelisk_enemy'                => 'No se pudo importar el Obelisco Despierto :name, su enemigo no se pudo resolver para tu combinación de mazmorra/semana.',
    ...
    'combatlog' => [
        'enemy_failure_analysis' => [
            'verdict' => [
                ...
                'wrong_floor_artifact' => 'Probablemente un artefacto de planta equivocada',
            ],
            'suggestion' => [
                'npc_not_mapped'       => ':npc no está en esta versión de mapeo en absoluto, y aun así se ha combatido :count veces en :routes rutas aquí. Añádelo (o su pack) en esta ubicación.',
                ...
                'wrong_floor_artifact' => 'Ningún :npc dentro del alcance en esta planta, pero hay uno a menos de :distance yardas en otra planta. La planta registrada se deduce del npc anterior en el registro, así que lo más probable es que sea esa deducción: verifícalo antes de cambiar el mapeo.',
            ],
        ],
    ],
