...
return [
    'index' => [
        ...
        'cards' => [
            ...
            'tuning' => [
                'title'        => 'Bilanciamento incantesimi',
                'description'  => 'Cosa ha cambiato ogni patch del gioco negli incantesimi degli NPC: danno in aumento o in calo, durate, tempi di recupero - nei numeri che i giocatori vedono davvero.',
                'cta'          => 'Visualizza il bilanciamento',
                'count_suffix' => 'build confrontate',
            ],
            'class' => [
                'title'        => 'Per classe',
    ...
    'sections' => [
        ...
        'tuning_change_list' => [
            ...
            'changed_to'     => 'modificato in',
            'shared_by'      => 'Record di incantesimo che condividono questa modifica: :count',
        ],
    ],
    'tuning' => [
        'index' => [
            'title'             => 'Bilanciamento incantesimi - Compendio',
            'header'            => 'Bilanciamento incantesimi',
            'header_dungeon'    => 'Bilanciamento incantesimi - :dungeon',
            'intro'             => 'Cosa ha cambiato ogni patch del gioco negli incantesimi degli NPC, nei numeri che i giocatori vedono davvero. Contano solo le modifiche ai numeri - una descrizione riformulata con gli stessi numeri non viene elencata.',
            'empty'             => 'Nessuna modifica di bilanciamento registrata ancora.',
