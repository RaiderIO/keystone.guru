...
return [
    ...
    'edit' => [
        ...
        'creator_pinned_routes_empty'      => 'Ainda não há rotas fixadas.',
        'creator_pinned_routes_none'       => 'Você ainda não criou nenhuma rota, então não há nada para fixar.',
        'creator_pinned_collections'       => 'Coleções fixadas',
        'creator_pinned_collections_none'  => 'Você ainda não criou nenhuma coleção.',
        'creator_pinned_collections_help'  => 'Mantenha ctrl (ou cmd) pressionado para selecionar até :max coleções para destacar acima das suas rotas. Coleções que não são visíveis publicamente permanecem ocultas de outras pessoas mesmo quando fixadas.',
        'creator_pinned_collections_empty' => 'Ainda não há coleções fixadas.',
