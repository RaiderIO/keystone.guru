...
return [
    ...
    'edit' => [
        ...
        'patreon_status_for_admin'                         => 'Se le han otorgado a tu cuenta todos los beneficios de :patreon porque eres el administrador. ¡Hola, yo mismo!',
        ...
        'link_to_patreon_admin'                            => '¡Vincula la cuenta de administrador a Patreon para que los trabajos de sincronización funcionen correctamente!',
        ...
        'ad_free_giveaway'     => [
            'title'                                      => 'Obsequio sin anuncios',
            'ad_free_giveaway_description_not_available' => 'Suscribirte a :patreon te permite regalar hasta :max experiencias sin anuncios de Keystone.guru a cualquier miembro del equipo.',
            'ad_free_giveaway_description_available'     => '¡Gracias por suscribirte a :patreon! Puedes regalar :current experiencias sin anuncios más de Keystone.guru a cualquier miembro del equipo.',
            'table_header_team'                          => 'Equipo',
            'table_header_member'                        => 'Miembro',
            'table_header_ad_free'                       => 'Sin anuncios',
        ],
        ...
        'creator_description'              => 'Tu perfil público es lo que la gente ve cuando abre un enlace a tus rutas. Agrega una biografía, vincula tus canales y fija las rutas que quieres que la gente pruebe primero.',
        ...
        'creator_socials_help'             => 'Solo se aceptan enlaces https del sitio correspondiente. Deja un campo vacío para eliminar ese enlace.',
        'creator_pinned_routes'            => 'Rutas fijadas',
        'creator_pinned_routes_help'       => 'Elige hasta :max de tus propias rutas para destacarlas en la parte superior de tu perfil. Las rutas que no están publicadas permanecen ocultas para otras personas aunque estén fijadas.',
        ...
        'creator_pinned_collections_help'  => 'Mantén presionado ctrl (o cmd) para seleccionar hasta :max colecciones que quieras destacar encima de tus rutas. Las colecciones que no son visibles públicamente permanecen ocultas para otras personas aunque estén fijadas.',
        ...
        'creator_directory_hide_help'      => 'Los creadores con rutas publicadas se listan automáticamente en el directorio. Marca esta casilla para mantener tu perfil fuera de él; tus rutas seguirán publicadas de cualquier forma.',
