...
return [
    'directory' => [
        ...
        'description'        => 'Explora a las personas que crean rutas en Keystone.guru. Los creadores con rutas publicadas se listan automáticamente; abre un perfil para ver sus rutas fijadas y dónde más encontrarlos.',
        'search_label'       => 'Buscar un creador',
        'search_placeholder' => 'Buscar por nombre',
        'search_submit'      => 'Buscar',
        'category_label'     => 'Filtrar por el tipo de colecciones que comparte un creador',
        'category_any'       => 'Cualquier colección',
