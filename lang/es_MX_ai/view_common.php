...
return [
    ...
    'collection' => [
        ...
        'routes' => [
            ...
            'help'             => 'Los cambios en las rutas se guardan de inmediato. Arrastra una ruta desde su ícono de arrastre, o usa sus flechas, para definir el orden en que la colección la muestra.',
            'help_new'         => 'Elige las rutas con las que empieza esta colección. Se guardan en cuanto la creas. Arrastra una ruta desde su ícono de arrastre, o usa sus flechas, para definir el orden en que la colección la muestra.',
        ...
        'details' => [
            ...
            'category_help'              => 'Qué tipo de rutas contiene esta colección. El nivel de llave queda fuera a propósito: una colección apta para PUG lo es en cualquier nivel de llave.',
            ...
            'season_help'                => 'Un espacio por cada mazmorra de la temporada; no se puede cambiar después.',
            ...
            'dungeon_routes_load_failed' => 'No se pudieron cargar tus rutas para esta versión del juego y temporada. Vuelve a elegirla para intentarlo de nuevo.',
            'enemy_forces_short'         => 'Por debajo de las fuerzas enemigas requeridas',
    ...
    'dungeonroute' => [
        ...
        'picker' => [
            ...
            'load_failed'                  => 'No se pudieron cargar las rutas. Cambia un filtro, o vuelve a abrir este panel, para intentarlo de nuevo.',
            'previous'                     => 'Anterior',
            'next'                         => 'Siguiente',
    ...
    'forms' => [
        ...
        'orderedselect' => [
            ...
            'remove'         => 'Quitar :name',
            'added_status'   => 'Se agregó :name en la posición :position',
            'moved_status'   => 'Se movió :name a la posición :position',
            'removed_status' => 'Se quitó :name',
        ],
        'passwordinput' => [
    ...
    'layout' => [
        ...
        'header' => [
            ...
            'create_route'                    => 'Crear ruta',
            'create_route_description'        => 'Planea tu propia ruta en el mapa de la mazmorra',
            'search'                          => 'Buscar',
            'routes'                          => ':expansion',
            'category_routes'                 => 'Rutas',
            'category_dungeons'               => 'Mazmorras',
            'category_developer'              => 'Desarrollador',
            'dev_route_info_description'      => 'Inspeccionar el modelo sin procesar de la ruta',
            'dev_combatlog_info_description'  => 'La ejecución del registro de combate a partir de la cual se creó esta ruta',
            'dev_mapping_version_description' => 'Abrir la versión de mapeo de esta ruta en el editor de mapeo',
            'browse_routes'                   => 'Explorar rutas',
            'browse_routes_description'       => 'Rutas publicadas para la mazmorra que elegiste',
            'find_routes'                     => 'Buscar rutas',
            'find_routes_description'         => 'Elige los enemigos que una ruta debe incluir en sus pulls u omitir',
            'heatmaps'                        => 'Mapas de calor',
            'heatmaps_description'            => 'Ve dónde ocurren wipes o se lanzan hechizos, con muchos filtros',
            ...
            'compendium_overview_description' => 'Todo lo que la comunidad registró esta temporada',
            'npc_compendium'                  => 'NPCs',
            ...
            'compendium_activity_description' => 'Las observaciones más recientes de los registros de combate, por día',
            'compendium_tuning'               => 'Ajustes de hechizos',
            'compendium_tuning_description'   => 'Cómo cambiaron los hechizos entre builds del juego',
            'class_compendium'                => 'Por clase',
            'class_compendium_description'    => 'Lo esencial sobre las habilidades de tu clase contra NPCs y hechizos',
        ],
        'nav' => [
            'dungeoncontext' => [
        ...
        'controls' => [
            ...
            'combatlogrouteenemyfailures' => [
                ...
                'cluster_popup'          => [
                    ...
                    'nearest_enemy' => 'Enemigo mapeado más cercano: :id a :distance yardas (piso :floor, pack :pack)',
                    'nearest_none'  => 'No hay ningún enemigo correspondiente a este NPC en la versión de mapeo',
                    'in_range'      => ':count mapeados dentro del alcance en este piso',
            ...
            'combatlogrouteenemyresolutions' => [
                ...
                'metric_average'          => 'Distancia promedio',
                ...
                'line_popup'              => [
                    ...
                    'weighted'       => 'Por la prioridad de muerte se valoró como :weighted yardas',
    ...
    'modal' => [
        ...
        'share' => [
            ...
            'upgrade_draft_cannot_publish'     => 'Esto es un borrador de actualización, así que no se puede compartir por sí solo. Aplícalo a la ruta que actualiza para publicar tus cambios: esa ruta conserva su enlace, sus calificaciones y sus favoritos.',
