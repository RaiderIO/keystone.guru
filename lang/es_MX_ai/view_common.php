...
return [
    ...
    'forms' => [
        ...
        'mapsettings' => [
            ...
            'kill_zone_path_weight'                         => 'Grosor del trazo del trayecto del pull',
            'kill_zone_path_weight_title'                   => 'Esto controla el grosor de la línea dibujada entre tus pulls en el mapa. Un valor más alto hace la línea más gruesa.',
            'drawing'                                       => 'Dibujo',
