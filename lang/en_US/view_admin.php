...
return [
    ...
    'tools' => [
        ...
        'list' => [
            ...
            'combatlog_parse_failures'                                => 'Combat log parse failures',
            'combatlog_parse_failures_description'                    => 'Runs that failed to parse — inspect the failing line and re-download the log.',
        ...
        'combatlog' => [
            ...
            'parsefailures' => [
                'title'                      => 'Combat log parse failures',
                'header'                     => 'Combat log parse failures',
                'description'                => 'Runs whose combat log failed to parse. Inspect the failing line, re-download the raw log from a fresh temporary URL, then mark the failure resolved.',
                'empty'                      => 'No parse failures — everything is parsing cleanly.',
                'column_run_id'              => 'Run ID',
                'column_version'             => 'Log version',
                'column_line'                => 'Line',
                'column_message'             => 'Message',
                'column_class'               => 'Exception',
                'column_created'             => 'First seen',
                ...
                'resolve'                    => 'Resolve',
                'segment'                    => 'Segment',
                'segments_modal_title'       => 'Download combat log for run',
                'segments_modal_description' => 'These are freshly generated, short-lived download links — download promptly, they expire within minutes.',
                'segments_error'             => 'Could not fetch the download links. Please try again.',
            ],
        ],
        'wagogg' => [
