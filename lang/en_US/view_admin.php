...
return [
    ...
    'tools' => [
        'telemetry' => [
            'title'               => 'Telemetry',
            'header'              => 'Telemetry',
            'description'         => 'Scheduled command run times and the site gauges sampled every five minutes, as recorded in telemetry_metrics. Every measurement that has data in the selected period is graphed - a new gauge shows up here on its own.',
            'range'               => 'Period',
            'refresh'             => 'Refresh',
            'retention_note'      => 'Only :measurements are kept beyond :days days - everything else is pruned, so a longer period shows a shorter line for it.',
            'no_data'             => 'No telemetry has been recorded in this period yet.',
            'chart_no_data'       => 'No data in this period.',
            'chart_load_failed'   => 'Failed to load this chart.',
            'subheader_scheduler' => 'Scheduled command run times',
            'subheader_gauges'    => 'Site gauges',
            'legend_average'      => ':label (avg)',
            'legend_maximum'      => ':label (max)',
            'legend_failures'     => 'Failed runs',
            'axis_duration'       => 'Duration (ms)',
            'axis_value'          => 'Value',
            'measurement'         => [
                'user_count'          => 'Users',
                'team_count'          => 'Teams',
                'dungeon_route_count' => 'Dungeon routes',
                'queue'               => 'Queue sizes',
                'mysql'               => 'MySQL connections',
                'redis'               => 'Redis keys per database',
            ],
            'range_option' => [
                '24h' => 'Last 24 hours',
                '7d'  => 'Last 7 days',
        ...
        'patreon' => [
            'grants' => [
                'title'              => 'Manual Patreon grants',
                'header'             => 'Manual Patreon grants',
                'description'        => 'Everyone currently holding Patreon benefits that were granted by hand instead of paid for. An active grant overrides whatever tier the hourly Patreon sync would otherwise apply, so it stays in place until it is revoked here.',
                'column_user'        => 'User',
                'column_email'       => 'Email',
                ...
                'revoke'             => 'Revoke',
                'confirm_revoke'     => 'Are you sure you want to revoke this grant? The user loses these benefits immediately.',
                'empty'              => 'Nobody currently holds manually granted Patreon benefits.',
                'reason_unknown'     => 'Unknown - granted before grants were recorded',
                'granted_by_unknown' => 'Unknown',
                'benefits_none'      => 'None',
                'real_link'          => 'Real patron',
                'real_link_title'    => 'This user has a real Patreon link. Revoking the grant keeps the link, and the next sync restores the tier they actually pay for.',
            ],
        ],
        'bannedipaddresses' => [
            'list' => [
        ...
        'dungeonroute' => [
            'generatetestroutes' => [
                'title'                 => 'Generate test routes',
                'header'                => 'Generate test routes',
                'description'           => 'Creates throwaway routes on the current mapping version, owned by you. Each route kills every boss and reaches the required enemy forces with random pulls. Not available in production.',
                'target'                => 'Generate for',
                'target_seasons'        => 'Every dungeon of a season',
                'target_season'         => ':season (:count dungeons)',
                'target_season_current' => ':season (:count dungeons) - current',
                'target_dungeons'       => 'A single dungeon',
                'count'                 => 'Routes per dungeon (max :max)',
                'published_state'       => 'Published state',
                'generate'              => 'Generate',
                'generated_count'       => 'Generated test routes in this environment: :count',
                'delete_all'            => 'Delete all generated test routes',
                'delete_all_confirm'    => 'Delete every generated test route in this environment?',
                'log_invalid_count'     => 'Enter a route count between 1 and :max.',
                'log_generating'        => 'Generating :count route(s) for :dungeons dungeon(s)...',
                'log_dungeon_done'      => ':dungeon: :count route(s)',
                'log_deleting'          => 'Deleting generated test routes...',
                'log_deleted'           => 'Deleted :deleted, :remaining remaining.',
                'log_done'              => 'Done.',
        ...
        'list' => [
            ...
            'generate_test_routes'                                    => 'Generate test routes',
            'generate_test_routes_description'                        => 'Create throwaway routes for a dungeon or a whole season, and delete them again.',
            'subheader_mdt'                                           => 'MDT',
            ...
            'subheader_telemetry'                                     => 'Telemetry',
            'view_telemetry'                                          => 'Telemetry dashboard',
            'view_telemetry_description'                              => 'Graphs of scheduled command run times and the site gauges sampled every five minutes.',
            'subheader_patreon'                                       => 'Patreon',
            'manage_patreon_manual_grants'                            => 'Manual Patreon grants',
            'manage_patreon_manual_grants_description'                => 'Review who was handed Patreon benefits by an admin, why, and since when - and revoke the ones that are no longer justified.',
    ...
    'user' => [
        'list' => [
            ...
            'grant_all_benefits_header'             => 'Grant all Patreon benefits',
            'grant_all_benefits_description'        => 'Grant every Patreon benefit, for free, to',
            'grant_all_benefits_reason'             => 'Reason',
            'grant_all_benefits_reason_placeholder' => 'Bought the top tier but it never applied',
            'grant_all_benefits_submit'             => 'Grant all benefits',
        ],
    ],
    'userreport' => [
        'list' => [
