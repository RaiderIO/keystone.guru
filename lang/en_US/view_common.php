...
return [
    ...
    'collection' => [
        ...
        'details' => [
            ...
            'game_version_help'           => 'Only routes for this game version can be added.',
            'game_version_fixed'          => 'The game version cannot change once the collection holds a route.',
            'season'                      => 'Season',
            'season_none'                 => 'No season (free-form)',
            'season_help'                 => 'A season set shows one slot per dungeon of the season, and only takes routes of that season. The season cannot be changed later.',
            'season_make_free_form'       => 'Choose "No season (free-form)" to make this a free-form collection. This cannot be undone.',
            'kind_changed'                => 'Routes for this game version or season can be added once the collection is created.',
            ...
            'dungeon_routes_slot_help'    => 'Only your own routes for :dungeon in this season can be added here.',
            'dungeon_routes_foreign'      => 'Doesn\'t match this collection',
            'dungeon_routes_foreign_help' => 'These routes are not for this collection\'s game version or season. They can be removed, but no route can be added here.',
            'dungeon_routes_empty'        => 'No routes in this collection yet.',
            'dungeon_routes_help'         => 'Only your own routes can be added. Drag a route by its handle, or use its arrows, to set the order the collection shows it in.',
            'save'                        => 'Save',
    ...
    'dungeonroute' => [
        ...
        'picker' => [
            ...
            'already_in'                   => 'Already added',
            'unpublished'                  => 'Hidden from others until published',
            'key_level'                    => '+:level',
            'key_range'                    => '+:min – +:max',
            ...
            'full'                         => 'No more routes fit: the limit is :max.',
            'cancel'                       => 'Cancel',
            'add_none'                     => 'Add routes',
            'add_one'                      => 'Add 1 route',
            'add_many'                     => 'Add :count routes',
            'add_failed'                   => 'The routes could not be added.',
        ],
        'tier' => [
    ...
    'forms' => [
        ...
        'orderedselect' => [
            ...
            'add'            => 'Add',
            'full'           => 'The list is full: remove one to add another (maximum :max).',
            'move_up'        => 'Move :name up',
            'move_down'      => 'Move :name down',
            'remove'         => 'Remove :name',
            'added_status'   => 'Added :name at position :position',
            'moved_status'   => 'Moved :name to position :position',
            'removed_status' => 'Removed :name',
        ],
        'passwordinput' => [
