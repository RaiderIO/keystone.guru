...
return [
    ...
    'tuning' => [
        'index' => [
            ...
            'build_no_changes'         => 'This build did not change the numbers of any NPC spell.',
            'build_no_changes_dungeon' => 'This build did not change the numbers of any NPC spell in this dungeon.',
        ],
    ],
    'class' => [
        'index' => [
