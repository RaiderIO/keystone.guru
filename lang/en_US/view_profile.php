...
return [
    ...
    'edit' => [
        ...
        'creator_pinned_routes_help'               => 'Pick up to :max of your own routes to highlight at the top of your profile. Routes that are not published stay hidden from other people even when pinned.',
        'creator_pinned_routes_none'               => 'You have not created any routes yet, so there is nothing to pin.',
        'creator_pinned_routes_filter_placeholder' => 'Search your routes by name or dungeon...',
