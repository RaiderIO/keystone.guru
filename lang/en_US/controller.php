...
return [
    ...
    'dungeonroutecollection' => [
        'flash' => [
            ...
            'collection_duplicated_left_out' => '{1} :count route was left out because it does not match the chosen season or does not fit the route limits.|[2,*] :count routes were left out because they do not match the chosen season or do not fit the route limits.',
        ],
    ],
    'profile' => [
        'flash' => [
