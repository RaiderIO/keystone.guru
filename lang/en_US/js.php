...
return [
    ...
    'enemyforcescheckpoint_title' => 'Add an enemy forces checkpoint',
    ...
    'right_click_to_open_details_label'             => 'Right-click to open details',
    'shift_right_click_to_assign_raid_marker_label' => 'Shift + right-click to assign a raid marker',
    ...
    'spell_label'                                   => 'Spell',
    'spell_schools_label'                           => 'Schools',
    'spell_miss_types_label'                        => 'Miss types',
    'spell_dispel_type_label'                       => 'Dispel type',
    'spell_mechanic_label'                          => 'Mechanic',
    'spell_cast_time_label'                         => 'Cast time',
    'spell_duration_label'                          => 'Duration',
    'npc_health_label'                              => 'Health',
    'npc_type_label'                                => 'Type',
    'npc_type_label'                                => 'Type',
    'npc_characteristics_label'                     => 'Crowd control observed',
    ...
    'arrow_color_animated_label'                                           => 'Animated color',
    'arrow_weight_label'                                                   => 'Weight',
    ...
    // Enemy forces
    'enemyforcescheckpoint_map_object_group_label'           => 'Enemy forces checkpoints',
    ...
    'enemy_forces_checkpoint_pill_enemy_forces'              => ':enemyForces EF required',
    'enemy_forces_checkpoint_pill_percentage'                => ':percentage% required',
    'enemy_forces_checkpoint_tooltip_enemy_forces'           => ':name holds :enemyForces EF',
    'enemy_forces_checkpoint_tooltip_percentage'             => ':name holds :percentage%',
    'enemy_forces_checkpoint_tooltip_spans_floors'           => '(spans :floors floors)',
    'enemy_forces_checkpoint_unnamed_label'                  => 'Unnamed checkpoint',
    'enemy_forces_checkpoint_snackbar_editing'               => 'Editing :name',
    'enemy_forces_checkpoint_snackbar_summary'               => ':enemies enemies - :amount',
    'enemy_forces_checkpoint_snackbar_enemy_forces'          => ':enemyForces EF',
    'enemy_forces_checkpoint_snackbar_percentage'            => ':percentage%',
    'enemy_forces_checkpoint_snackbar_done_label'            => 'Done',
    'enemyforcescheckpoint_name_label'                       => 'Name',
    'enemyforcescheckpoint_faction_label'                    => 'Faction',
    'enemyforcescheckpoint_teeming_label'                    => 'Teeming',
    'enemyforcescheckpoint_select_enemies_label'             => 'Select enemies',
    'enemyforcescheckpoint_select_enemies_button_text_label' => 'Select enemies',
    ...
    'mapping_version_upgrade_draft_label'          => 'You are editing an upgrade draft. Your changes go live only when you apply them.',
    ...
    'upgrade_draft_in_progress_badge_title'        => 'An upgrade draft is being worked on for this route. This route keeps serving its current content until the draft is applied.',
    'upgrade_draft_of_label'                       => 'View the route it upgrades',
    'mapping_version_upgrade_route_replaced_label' => 'This route was replaced by an applied upgrade draft. Refresh the page to see the new version.',
    ...
    'thumbnail_carousel_label'                 => 'Route thumbnails',
    'thumbnail_carousel_previous'              => 'Previous thumbnail',
    'thumbnail_carousel_next'                  => 'Next thumbnail',
    ...
    'scheduled_publish_saved'                                        => 'Scheduled publish saved successfully',
    'scheduled_publish_cleared'                                      => 'Scheduled publish cleared successfully',
    'scheduled_publish_state_team_label'                             => 'Team',
    'scheduled_publish_state_world_with_link_label'                  => 'Everyone with link',
    'scheduled_publish_state_world_label'                            => 'Everyone',
    'scheduled_publish_save_label'                                   => 'Save',
    'scheduled_publish_clear_label'                                  => 'Clear',
    ...
    'collection_dungeonroutes_save_failed'           => 'Your change could not be saved. Reload the page and try again.',
    'add_to_collection_loading'                      => 'Loading your collections…',
    'add_to_collection_load_failed'                  => 'Your collections could not be loaded. Try again later.',
    'add_to_collection_count'                        => ':count / :max',
    'add_to_collection_new_collection'               => 'New collection with this route…',
    'add_to_collection_no_collections'               => 'You have no collections yet.',
    'add_to_collection_max_collections'              => 'You have :max collections, the most you may have.',
    ...
    'dungeonroute_picker_enemy_forces'        => ':count/:required enemy forces',
    'dungeonroute_picker_pulls_one'           => '1 pull',
    'dungeonroute_picker_pulls_many'          => ':count pulls',
    'dungeonroute_picker_views'               => ':count views',
    'dungeonroute_picker_votes'               => ':count vote(s)',
    'dungeonroute_picker_selected_none'       => 'No routes selected',
    'dungeonroute_picker_selected_one'        => '1 route selected',
    'dungeonroute_picker_selected_many'       => ':count routes selected',
    'dungeonroute_picker_full'                => 'No more routes fit: the limit is :max.',
    'dungeonroute_picker_dungeon_full'        => 'Some dungeons are full: a collection holds at most :max routes of each.',
    ...
    'dungeonroute_picker_delete_gone'         => ':count of these routes were already deleted. The rest are still selected.',
    ...
    'team_add_routes_successful'                           => ':count routes successfully added to team',
    'team_add_routes_undo_label'                           => 'Undo',
    'team_add_routes_undone'                               => 'The added routes were removed from the team again',
    'team_add_routes_undo_failed'                          => 'Not every added route could be removed from the team again',
    ...
    'filter_input_select_player_spells_header'                 => 'Spells: :spells',
