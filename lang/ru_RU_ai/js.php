...
return [
    ...
    'route_continue_in_season_label'                  => 'Продолжить в :season',
    ...
    'route_continue_in_season_confirm_warning'        => 'Для :season будет создана копия этого маршрута на последней версии карты подземелья. Копия создаётся неопубликованной и сохраняет только те аффиксы, которые входят в :season. Ваш исходный маршрут останется без изменений. Вы хотите продолжить?',
    ...
    'team_add_routes_undone'                                               => 'Добавленные маршруты снова удалены из команды',
    'team_add_routes_undo_failed'                                          => 'Не все добавленные маршруты удалось снова удалить из команды',
