...
return [
    ...
    'mapping_version_upgrade_discard_label'                          => 'Отклонить',
    ...
    'mapping_version_upgrade_discard_confirm'                        => 'Отклонить этот черновик обновления? Все внесённые в него изменения будут потеряны. Маршрут, который он обновляет, останется без изменений. Это действие нельзя отменить.',
