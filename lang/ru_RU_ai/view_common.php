...
return [
    ...
    'collection' => [
        'addtocollection' => [
            ...
            'help'  => 'Маршрут сразу добавляется в конец коллекции.',
        ],
        'routes' => [
            'heading'          => 'Маршруты',
            'count'            => 'Маршруты: :count / :max',
            'help'             => 'Изменения в маршрутах сохраняются сразу. Перетащите маршрут за маркер или используйте его стрелки, чтобы задать порядок, в котором коллекция его показывает.',
            'help_new'         => 'Выберите маршруты, с которых начнётся эта коллекция. Они сохраняются, как только Вы её создадите. Перетащите маршрут за маркер или используйте его стрелки, чтобы задать порядок, в котором коллекция его показывает.',
            'picker_title_new' => 'Добавить маршруты в эту коллекцию',
            'owner_only'       => 'Добавлять маршруты в эту коллекцию может только её владелец.',
            'add_routes'       => 'Добавить маршруты',
            'add_route_for'    => 'Добавить маршрут для :dungeon',
            'picker_title'     => 'Добавить маршруты в :name',
        ],
        'details' => [
            'name'                       => 'Название',
            ...
            'category_help'              => 'Какие маршруты содержит эта коллекция. Уровень ключа намеренно не входит в категорию - коллекция, подходящая для PUG, подходит для PUG на любом уровне ключа.',
            'published_state'            => 'Кому видно',
            'published_state_help'       => 'Предоставление коллекции в общий доступ никогда не публикует маршруты внутри неё - неопубликованный маршрут остаётся скрытым.',
            'team'                       => 'Команда',
            'team_none'                  => 'Без команды',
            'team_help'                  => 'Команда, которой предоставляется эта коллекция, когда коллекция видна Вашей команде.',
            'season'                     => 'Сезон',
            'season_none'                => 'Без сезона (свободная)',
            'season_help'                => 'По одному месту на каждое подземелье сезона; позже изменить нельзя.',
            'season_make_free_form'      => 'Переход к свободной коллекции нельзя отменить.',
            'dungeon_routes'             => 'Маршруты',
            'dungeon_routes_none'        => 'Вы еще не создали ни одного маршрута.',
            'dungeon_routes_slot_empty'  => 'Для :dungeon пока нет маршрута.',
            'dungeon_routes_slot_count'  => ':count',
            'dungeon_routes_loading'     => 'Загрузка Ваших маршрутов для этой версии игры и сезона...',
            'dungeon_routes_load_failed' => 'Не удалось загрузить Ваши маршруты для этой версии игры и сезона. Выберите её снова, чтобы повторить попытку.',
            'enemy_forces_short'         => 'Меньше требуемых сил врага',
            'dungeon_routes_empty'       => 'В этой коллекции пока нет маршрутов.',
            'save'                       => 'Сохранить',
    ...
    'dungeon' => [
        ...
        'list' => [
            ...
            'card'        => [
                'this_week_tier' => 'Уровень сложности этой недели (archon.gg)',
            ],
        ],
        'gridtabs' => [
            'raid' => 'Рейд',
    ...
    'dungeonroute' => [
        ...
        'picker' => [
            'close'                        => 'Закрыть',
            'source_mine'                  => 'Ваши маршруты',
            'source_unassigned_by_members' => 'Маршруты участников %s, которые ещё не входят ни в одну команду',
            'title_search'                 => 'Название',
            'title_search_placeholder'     => 'Поиск по названию',
            'loading'                      => 'Загрузка маршрутов...',
            'empty'                        => 'Нет маршрутов, соответствующих этим фильтрам.',
            'load_failed'                  => 'Не удалось загрузить маршруты. Измените фильтр или откройте это окно снова, чтобы повторить попытку.',
            'previous'                     => 'Назад',
            'next'                         => 'Далее',
    ...
    'forms' => [
        'createroute' => [
            ...
            'dungeon_start_title'                            => 'У этого подземелья несколько входов. Выберите, с какого из них начинается ваш маршрут; это влияет на рассчитанный путь от начала до вашего первого пула.',
            'description'                                    => 'Описание',
        ...
        'mapsettings' => [
            ...
            'heatmap_render_order'                          => 'Порядок отрисовки',
            'heatmap_render_order_title'                    => 'Определяет, отображается ли тепловая карта поверх врагов или позади них.',
            'heatmap_render_order_on_top'                   => 'Сверху',
            'heatmap_render_order_behind'                   => 'Позади',
            'enemies'                                       => 'Враги',
            ...
            'kill_zone_path'                                => 'Путь пула',
            'kill_zone_path_weight'                         => 'Толщина линии пути пула',
            'kill_zone_path_weight_title'                   => 'Определяет толщину линии, нарисованной между вашими пулами на карте. Большее значение делает линию толще.',
            'drawing'                                       => 'Рисование',
        ...
        'orderedselect' => [
            ...
            'add'            => 'Добавить',
            'full'           => 'Список заполнен: удалите элемент, чтобы добавить другой (максимум :max).',
            'move_up'        => 'Переместить :name вверх',
            'move_down'      => 'Переместить :name вниз',
            'remove'         => 'Удалить :name',
            'added_status'   => 'Добавлено: :name, позиция :position',
            'moved_status'   => 'Перемещено: :name, позиция :position',
            'removed_status' => 'Удалено: :name',
        ],
        'passwordinput' => [
    ...
    'layout' => [
        ...
        'header' => [
            ...
            'create_route'                    => 'Создать маршрут',
            'create_route_description'        => 'Спланируйте собственный маршрут на карте подземелья',
            'search'                          => 'Поиск',
            'routes'                          => ':expansion',
            'category_routes'                 => 'Маршруты',
            'category_dungeons'               => 'Подземелья',
            'category_developer'              => 'Разработчик',
            'dev_route_info_description'      => 'Просмотреть исходную модель маршрута',
            'dev_combatlog_info_description'  => 'Прохождение из боевого журнала, из которого был создан этот маршрут',
            'dev_mapping_version_description' => 'Открыть версию карты этого маршрута в редакторе карт',
            'browse_routes'                   => 'Просмотр маршрутов',
            'browse_routes_description'       => 'Опубликованные маршруты для выбранного подземелья',
            'find_routes'                     => 'Поиск маршрутов',
            'find_routes_description'         => 'Выберите врагов, которых маршрут должен включать или пропускать',
            'heatmaps'                        => 'Тепловые карты',
            'heatmaps_description'            => 'Узнайте, где погибают группы или используются заклинания, с множеством фильтров',
            'explore'                         => 'Исследовать подземелья',
            'explore_description'             => 'Изучите карту подземелья со всеми паками и патрулями',
            'new'                             => 'Новые',
            'compendium'                      => 'Компендиум',
            'compendium_overview'             => 'Обзор',
            'compendium_overview_description' => 'Всё, что сообщество записало в этом сезоне',
            'npc_compendium'                  => 'НПЦ',
            'npc_compendium_description'      => 'Что делает каждый враг, что применяет и что на него действует',
            'spell_compendium'                => 'Заклинания',
            'spell_compendium_description'    => 'Что делает заклинание и как ему противостоять',
            'compendium_activity'             => 'Активность',
            'compendium_activity_description' => 'Последние наблюдения из боевых логов по дням',
            'compendium_tuning'               => 'Балансировка заклинаний',
            'compendium_tuning_description'   => 'Как менялись заклинания между сборками игры',
            'class_compendium'                => 'По классу',
            'class_compendium_description'    => 'Главное о способностях Вашего класса против НПЦ и заклинаний',
        ],
        'nav' => [
            'dungeoncontext' => [
                'change_dungeon' => 'Сменить подземелье',
            ],
            'user' => [
                'login'                      => 'Вход',
                'register'                   => 'Регистрация',
                ...
                'view_affixes'               => 'Просмотр аффиксов',
                'view_seasons'               => 'Просмотр сезонов',
                'view_npcs'                  => 'Просмотр НПС',
                'view_spells'                => 'Просмотр заклинаний',
                'view_users'                 => 'Просмотр пользователей',
                'view_patreon_manual_grants' => 'Просмотр преимуществ Patreon, предоставленных вручную',
                'view_telemetry'             => 'Просмотр телеметрии',
                'view_dungeonroutes'         => 'Просмотр маршрутов подземелий',
        ...
        'controls' => [
            ...
            'elements' => [
                ...
                'enemydisplaytype' => [
                    ...
                    'npc_type'                 => 'Тип',
                    'enemy_forces'             => 'Силы врага',
                    'enemy_display_type'       => 'Визуализация',
                    'enemy_display_type_title' => 'Визуализация',
            ...
            'heatmapsearch' => [
                ...
                'player_spells'          => 'Заклинания',
                'npc_death_alt'          => 'Смерть врага',
                'player_death_alt'       => 'Смерть игрока',
                'spell_casts_alt'        => 'Применения заклинаний',
                'filter'                 => 'Фильтр',
                'key_level'              => 'Уровень ключа',
            ...
            'combatlogrouteenemyfailures' => [
                'mapping_version_filter' => 'Версия карты',
                'npc_filter'             => 'Фильтр НПЦ',
                'show_clusters'          => 'Показать кластеры сбоев',
                'clusters_legend'        => 'Классификация кластеров',
                'cluster_low_volume'     => 'бледный = мало данных',
                'cluster_popup'          => [
                    'failures'      => 'Сбоев: :count в :routes маршрутах (:avg на маршрут)',
                    'nearest_enemy' => 'Ближайший размеченный враг: :id в :distance ярд. (уровень :floor, пак :pack)',
                    'nearest_none'  => 'В этой версии карты нет врагов, соответствующих этому НПЦ',
                    'in_range'      => 'Размечено в радиусе на этом уровне: :count',
                    'seen'          => 'Замечено :first – :last',
                    'filter_npc'    => 'Фильтр по этому НПЦ',
                ],
                'not_mapped'           => 'не размечен',
                'clear_failures'       => 'Очистить сбои',
            ...
            'combatlogrouteenemyresolutions' => [
                'explanation'             => 'Враги, которые были сопоставлены, но с размеченным врагом на расстоянии не менее :distance ярд. Горячая точка, которая появляется снова и снова, - признак того, что враги там размещены неправильно.',
                'mapping_version_filter'  => 'Версия карты',
                'npc_filter'              => 'Фильтр НПЦ',
                'metric_filter'           => 'Вес ячейки',
                'metric_average'          => 'Среднее расстояние',
                'metric_max'              => 'Худшее расстояние',
                'min_distance_filter'     => 'Минимальное расстояние (ярд.)',
                'summary'                 => 'Показано сопоставлений: :drawn из :total, худшая ячейка: :max ярд.',
                'clear_resolutions'       => 'Очистить сопоставления',
                'clear_resolutions_title' => 'Удалить все записи сопоставлений для этого подземелья',
                ...
                'line_popup'              => [
                    ...
                    'weighted'       => 'С учётом приоритета убийства оценено как :weighted ярд.',
                    'route'          => 'Открыть маршрут :key',
                    'imported_route' => 'Записано на :source, там маршрут :id',
                    'no_route'       => 'Для этого сопоставления маршрут не записан',
                ],
            ],
            'header' => [
            ...
            'view' => [
                ...
                'add_to_collection_title'        => 'Добавить в коллекцию',
    ...
    'mappingversion' => [
        'select' => [
            'mapping_version_previous' => ':gameVersion версия :version (предыдущая версия)',
    ...
    'modal' => [
        ...
        'share' => [
            ...
            'upgrade_draft_cannot_publish'     => 'Это черновик обновления, поэтому им нельзя поделиться отдельно. Примените его к маршруту, который он обновляет, чтобы опубликовать свои изменения — тот маршрут сохранит свою ссылку, оценки и число добавлений в избранное.',
    ...
    'team' => [
        'details' => [
            ...
            'route_publishing_enabled' => 'Публикация маршрутов включена',
        ],
        'select' => [
