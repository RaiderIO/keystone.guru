...
return [
    ...
    'collection' => [
        'details' => [
            ...
            'dungeon_routes_help'  => 'Удерживайте ctrl (или cmd), чтобы выбрать несколько маршрутов, максимум :max. Они отображаются в том порядке, в котором Вы их выбрали.',
            'save'                 => 'Сохранить',
    ...
    'maps' => [
        'controls' => [
            ...
            'combatlogrouteenemyresolutions' => [
                ...
                'lines_legend'            => 'Худшие сопоставления текущего фильтра в количестве :count по всем уровням этого подземелья, от места начала боя до врага, которому он был отнесён.',
                'line_popup'              => [
                    'npc'            => ':name (:id)',
