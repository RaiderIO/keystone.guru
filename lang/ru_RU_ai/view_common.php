...
return [
    ...
    'collection' => [
        ...
        'routes' => [
            ...
            'help'             => 'Изменения в маршрутах сохраняются сразу. Перетащите маршрут за ручку или используйте стрелки, чтобы задать порядок маршрутов в коллекции.',
            'help_new'         => 'Выберите маршруты, с которых начнётся эта коллекция. Они сохраняются, как только Вы её создадите. Перетащите маршрут за ручку или используйте стрелки, чтобы задать порядок маршрутов в коллекции.',
    ...
    'dungeonroute' => [
        ...
        'picker' => [
            ...
            'source_unassigned_by_members' => 'Маршруты участников %s, ещё не привязанные ни к одной команде',
    ...
    'layout' => [
        ...
        'header' => [
            ...
            'dev_combatlog_info_description'  => 'Прохождение из боевого журнала, на основе которого создан этот маршрут',
