    ...
    'mdt' => [
        'io' => [
            ...
            'import_string' => [
                ...
                'unable_to_find_awakened_obelisk_enemy'                => 'Не удалось импортировать Пробуждённый обелиск :name, его врага не удалось определить для вашей комбинации подземелья и недели.',
