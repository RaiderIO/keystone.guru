    ...
    'combatlog' => [
        'enemy_failure_analysis' => [
            ...
            'suggestion' => [
                ...
                'enemies_exhausted'    => 'Размеченных :npc в радиусе: :enemies, но маршруты всё равно дают здесь примерно :avg сбоев каждый — вероятно, в игре в этом паке больше :npc, чем в разметке.',
                'wrong_floor_artifact' => 'На этом уровне :npc в радиусе нет, но есть один в пределах :distance ярд. на другом уровне. Записанный уровень выводится по предыдущему нпц в логе, поэтому это скорее всего результат такого вывода — проверьте, прежде чем менять разметку.',
            ],
        ],
    ],
