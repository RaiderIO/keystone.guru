...
return [
    ...
    'mapping' => [
        ...
        'dungeon'                       => 'Подземелье',
        'enemy_forces_assigned'         => 'Силы врага закреплены за неигровыми NPC',
        'npcs_assigned_to_enemies'      => 'NPC отмечен как враг',
        'teeming'                       => 'Кишащий',
    ...
    'status' => [
        ...
        'check_failed' => 'Проверка не пройдена, подробности см. в журнале приложения',
    ],
