...
return [
    ...
    'edit' => [
        ...
        'creator_pinned_routes_help'       => 'Ваши закрепленные маршруты выделяются в верхней части Вашего профиля в этом порядке. Неопубликованные маршруты остаются скрытыми от других, даже если закреплены.',
        ...
        'creator_pinned_collections_help'  => 'Ваши закрепленные коллекции выделяются над Вашими маршрутами в этом порядке. Коллекции, не видимые публично, остаются скрытыми от других, даже если они закреплены.',
