...
return [
    ...
    'edittabs' => [
        ...
        'routepublishing' => [
            ...
            'description'      => 'Публикация маршрутов позволяет вам публиковать маршруты для всего мира по расписанию. Вы можете задать дату/время для каждого маршрута, когда он автоматически перейдет в состояние "Опубликован" и станет видимым для всех.',
            'enabled'          => 'Включено',
            'timezone_warning' => 'Запланированное время публикации использует часовой пояс вашего профиля. Убедитесь, что ваш часовой пояс правильно указан в :link.',
            'profile_link'     => 'настройках профиля',
        ],
        'routes' => [
            'title'                  => 'Список маршрутов',
            'add_route'              => 'Добавить маршруты',
            'add_route_no_moderator' => 'Вы должны быть модератором этой команды, чтобы добавлять маршруты',
            'picker_title'           => 'Добавить маршруты в %s',
        ],
        'tags' => [
            'title'       => 'Теги',
