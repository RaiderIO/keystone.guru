...
return [
    ...
    'dungeonroute' => [
        ...
        'continue_in_newer_season' => [
            ...
            'no_newer_season' => 'Этот маршрут нельзя продолжить в более новом сезоне: его подземелье не входит ни в один более новый сезон, или Вы уже продолжили его там.',
        ],
    ],
