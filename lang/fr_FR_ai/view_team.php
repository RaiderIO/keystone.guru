...
return [
    ...
    'edittabs' => [
        ...
        'members' => [
            ...
            'copy_to_clipboard_title'                    => 'Copier dans le presse-papiers',
            'refresh_invite_link_title'                  => 'Rafraîchir le lien d\'invitation',
        ...
        'routepublishing' => [
            ...
            'description'      => 'La publication programmée vous permet de publier des routes auprès du monde entier selon un calendrier. Vous pouvez définir une date/heure par route à laquelle elles seront automatiquement mises à l\'état Publiée et visibles pour tous.',
            'enabled'          => 'Activé',
    ...
    'edit' => [
        ...
        'team_header'    => 'Équipe %s',
        'icon_image_alt' => 'Pas d\'image',
        'routes'         => 'Itinéraires',
        'members'        => 'Membres',
    ],
    'invite' => [
        ...
        'header'                      => 'Invitation à rejoindre l\'équipe %s',
        'invalid_team'                => 'Équipe invalide',
        'logo_image_alt'              => 'Logo de l\'équipe',
        'already_a_member'            => 'Vous êtes déjà membre de l\'équipe %s !',
        'invited_to_join'             => 'Vous avez été invité à rejoindre l\'équipe %s.',
        'accept_the_invitation'       => 'Acceptez l\'invitation pour rejoindre l\'équipe !',
        'login_or_register_to_accept' => 'Connectez-vous ou inscrivez-vous sur Keystone.guru pour rejoindre l\'équipe, c\'est gratuit !',
        'return_to_team'              => 'Retour à l\'équipe',
