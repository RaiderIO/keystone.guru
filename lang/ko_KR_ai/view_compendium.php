...
return [
    'index' => [
        ...
        'cards' => [
            ...
            'tuning' => [
                'title'        => '주문 수치 조정',
                'description'  => '각 게임 패치가 NPC 주문에서 바꾼 내용입니다. 피해량 상승과 하락, 지속 시간, 재사용 대기시간 등 플레이어가 실제로 보는 수치를 보여줍니다.',
                'cta'          => '수치 조정 내역 보기',
    ...
    'tuning' => [
        'index' => [
            ...
            'intro'             => '각 게임 패치가 NPC 주문에서 바꾼 내용을 플레이어가 실제로 보는 수치로 보여줍니다. 수치가 바뀐 경우만 집계되며, 수치는 그대로인 채 문구만 바뀐 설명은 표시되지 않습니다.',
