...
return [
    ...
    'collection' => [
        'addtocollection' => [
            'title' => '컬렉션에 추가',
            'help'  => '경로는 즉시 컬렉션의 맨 끝에 추가됩니다.',
        ],
        'routes' => [
            'heading'          => '경로',
            'count'            => '경로 :count / :max개',
            'help'             => '경로 변경 사항은 즉시 저장됩니다. 경로의 핸들을 끌거나 화살표를 사용해 컬렉션에 표시되는 순서를 정하세요.',
            'help_new'         => '이 컬렉션을 시작할 경로를 고르세요. 컬렉션을 만들면 저장됩니다. 경로의 핸들을 끌거나 화살표를 사용해 컬렉션에 표시되는 순서를 정하세요.',
            'picker_title_new' => '이 컬렉션에 경로 추가',
            'owner_only'       => '이 컬렉션의 소유자만 경로를 추가할 수 있습니다.',
            'add_routes'       => '경로 추가',
            'add_route_for'    => ':dungeon 경로 추가',
            'picker_title'     => ':name에 경로 추가',
        ],
        'details' => [
            'name'                       => '이름',
            'description'                => '설명',
            ...
            'category_help'              => '이 컬렉션에 담긴 경로의 난이도입니다.',
            ...
            'season'                     => '시즌',
            'season_none'                => '시즌 없음 (자유 구성)',
            'season_help'                => '시즌의 던전마다 슬롯이 하나씩 생기며, 시즌은 나중에 변경할 수 없습니다.',
            'season_make_free_form'      => '자유 구성으로 전환하면 되돌릴 수 없습니다.',
            'dungeon_routes'             => '경로',
            'dungeon_routes_none'        => '아직 만든 경로가 없습니다.',
            'dungeon_routes_slot_empty'  => ':dungeon의 경로가 아직 없습니다.',
            'dungeon_routes_slot_count'  => ':count',
            'dungeon_routes_loading'     => '이 게임 버전과 시즌의 내 경로를 불러오는 중...',
            'dungeon_routes_load_failed' => '이 게임 버전과 시즌의 내 경로를 불러오지 못했습니다. 다시 시도하려면 다시 선택하세요.',
            'enemy_forces_short'         => '필요한 적 병력에 미달',
            'dungeon_routes_empty'       => '이 컬렉션에 아직 경로가 없습니다.',
            'save'                       => '저장',
            'submit'                     => '컬렉션 만들기',
            'delete'                     => '컬렉션 삭제',
        ],
    ...
    'dungeon' => [
        ...
        'list' => [
            ...
            'next_season' => '다음 시즌',
            'card'        => [
                'this_week_tier' => '이번 주 난이도 등급 (archon.gg)',
            ],
        ],
        'gridtabs' => [
            'raid' => '공격대',
    ...
    'dungeonroute' => [
        ...
        'leaderboard' => [
            'create_first_route' => '첫 번째 경로 만들기',
        ],
        'rating' => [
            'nr_of_votes' => '%s 투표',
        ],
        ...
        'picker' => [
            'close'                        => '닫기',
            'source_mine'                  => '내 경로',
            'source_unassigned_by_members' => '%s 멤버가 만든, 아직 팀에 속하지 않은 경로',
            'title_search'                 => '제목',
            'title_search_placeholder'     => '제목으로 검색',
            'loading'                      => '경로를 불러오는 중...',
            'empty'                        => '이 필터에 맞는 경로가 없습니다.',
            'load_failed'                  => '경로를 불러오지 못했습니다. 다시 시도하려면 필터를 변경하거나 이 창을 다시 여세요.',
            'previous'                     => '이전',
            'next'                         => '다음',
            'pagination'                   => '경로 페이지',
            'cancel'                       => '취소',
    ...
    'forms' => [
        'createroute' => [
            ...
            'dungeon_start'                                  => '던전 시작점',
            'dungeon_start_title'                            => '이 던전에는 여러 개의 입구가 있습니다. 경로가 시작될 입구를 선택하세요. 이는 시작 지점부터 첫 번째 풀까지의 계산된 경로에 영향을 줍니다.',
            'description'                                    => '설명',
        ...
        'mapsettings' => [
            ...
            'heatmap_render_order'                          => '렌더링 순서',
            'heatmap_render_order_title'                    => '히트맵이 적 위에 렌더링될지, 뒤에 렌더링될지를 제어합니다.',
            'heatmap_render_order_on_top'                   => '위',
            'heatmap_render_order_behind'                   => '뒤',
            'enemies'                                       => '적',
            ...
            'kill_zone_path'                                => '풀 경로',
            'kill_zone_path_weight'                         => '풀 경로선 굵기',
            'kill_zone_path_weight_title'                   => '지도에서 풀들 사이에 그려지는 선의 굵기를 제어합니다. 값이 높을수록 선이 더 두꺼워집니다.',
            'drawing'                                       => '그리기',
        ...
        'orderedselect' => [
            ...
            'add'            => '추가',
            'full'           => '목록이 가득 찼습니다. 다른 항목을 추가하려면 하나를 제거하세요 (최대 :max개).',
            'move_up'        => ':name 위로 이동',
            'move_down'      => ':name 아래로 이동',
            'remove'         => ':name 제거',
            'added_status'   => ':name을(를) :position번째 위치에 추가했습니다',
            'moved_status'   => ':name을(를) :position번째 위치로 이동했습니다',
            'removed_status' => ':name을(를) 제거했습니다',
        ],
        'passwordinput' => [
    ...
    'layout' => [
        ...
        'header' => [
            ...
            'create_route'                    => '경로 생성',
            'create_route_description'        => '던전 지도에서 나만의 경로를 계획하세요',
            'search'                          => '검색',
            'routes'                          => ':expansion',
            'category_routes'                 => '경로',
            'category_dungeons'               => '던전',
            'category_developer'              => '개발자',
            'dev_route_info_description'      => '경로의 원본 모델 검사',
            'dev_combatlog_info_description'  => '이 경로의 바탕이 된 전투 기록 런',
            'dev_mapping_version_description' => '이 경로의 매핑 버전을 매핑 편집기에서 열기',
            'browse_routes'                   => '경로 탐색',
            'browse_routes_description'       => '선택한 던전에 게시된 경로',
            'find_routes'                     => '경로 찾기',
            'find_routes_description'         => '경로에 반드시 포함하거나 건너뛸 적을 선택하세요',
            'heatmaps'                        => '히트맵',
            'heatmaps_description'            => '전멸이 일어나거나 주문이 시전되는 위치를 다양한 필터로 확인하세요',
            'explore'                         => '던전 탐색',
            'explore_description'             => '모든 무리와 순찰이 표시된 던전 지도를 둘러보세요',
            'new'                             => '신규',
            'compendium'                      => '도감',
            'compendium_overview'             => '개요',
            'compendium_overview_description' => '이번 시즌 커뮤니티가 기록한 모든 것',
            'npc_compendium'                  => 'NPC',
            'npc_compendium_description'      => '각 적이 무엇을 하고, 무엇을 시전하며, 무엇의 영향을 받는지',
            'spell_compendium'                => '주문',
            'spell_compendium_description'    => '주문의 효과와 대응 방법',
            'compendium_activity'             => '활동',
            'compendium_activity_description' => '날짜별 최신 전투 기록 관측 내역',
            'compendium_tuning'               => '주문 수치 조정',
            'compendium_tuning_description'   => '게임 빌드 사이에 주문이 어떻게 바뀌었는지',
            'class_compendium'                => '직업별',
            'class_compendium_description'    => 'NPC와 주문을 상대로 알아 두어야 할 내 직업 능력 정보',
        ],
        'nav' => [
            'dungeoncontext' => [
                'change_dungeon' => '던전 변경',
            ],
            'user' => [
                'login'                      => '로그인',
                'register'                   => '등록',
                ...
                'view_spells'                => '주문 보기',
                'view_users'                 => '사용자 보기',
                'view_patreon_manual_grants' => '수동 부여 Patreon 혜택 보기',
                'view_telemetry'             => '텔레메트리 보기',
                'view_dungeonroutes'         => '던전 경로 보기',
    ...
    'maps' => [
        'controls' => [
            ...
            'combatlogrouteenemyfailures' => [
                ...
                'npc_filter'             => 'NPC 필터',
                'show_clusters'          => '실패 군집 표시',
                'clusters_legend'        => '군집 판정',
                'cluster_low_volume'     => '흐림 = 적은 표본',
                'cluster_popup'          => [
                    'failures'      => ':routes개 경로에서 :count회 실패 (경로당 :avg회)',
                    'nearest_enemy' => '가장 가까운 매핑된 적: :id, 거리 :distance야드 (:floor층, 묶음 :pack)',
                    'nearest_none'  => '매핑 버전에 이 NPC에 해당하는 적이 없습니다',
                    'in_range'      => '이 층의 범위 내에 :count개 매핑됨',
                    'seen'          => ':first – :last 확인됨',
                    'filter_npc'    => '이 NPC로 필터',
                ],
                'not_mapped'           => '매핑되지 않음',
                'clear_failures'       => '실패 기록 지우기',
            ...
            'view' => [
                ...
                'add_to_collection_title'        => '컬렉션에 추가',
    ...
    'mappingversion' => [
        'select' => [
            'mapping_version_previous' => ':gameVersion 버전 :version (이전 버전)',
    ...
    'modal' => [
        ...
        'share' => [
            ...
            'upgrade_draft_cannot_publish'     => '이것은 업그레이드 초안이므로 단독으로 공유할 수 없습니다. 변경 사항을 게시하려면 업그레이드 대상 경로에 적용하세요. 그 경로는 링크와 평점, 즐겨찾기를 그대로 유지합니다.',
    ...
    'team' => [
        'details' => [
            ...
            'submit'                   => '제출',
            'disband_team'             => '팀 해산',
            'route_publishing_enabled' => '경로 게시 활성화됨',
        ],
        'select' => [
            'select_team' => '팀 선택...',
            'team'        => '팀',
