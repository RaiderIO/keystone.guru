...
return [
    ...
    'edittabs' => [
        ...
        'members'         => [
            ...
            'copy_to_clipboard_title'                    => '클립보드에 복사',
            'refresh_invite_link_title'                  => '초대 링크 새로 고침',
            'default_role'                               => '기본 역할',
    ...
    'invite'   => [
        ...
        'invalid_team'                => '잘못된 팀',
        'logo_image_alt'              => '팀 로고',
        'already_a_member'            => '당신은 이미 팀 %s의 멤버입니다!',
        'invited_to_join'             => '팀 %s에 가입하도록 초대받았습니다.',
        'accept_the_invitation'       => '팀에 가입하기 위해 초대를 수락하세요!',
        'login_or_register_to_accept' => '무료로 팀에 가입하려면 Keystone.guru에 로그인하거나 등록하세요!',
        'return_to_team'              => '팀으로 돌아가기',
