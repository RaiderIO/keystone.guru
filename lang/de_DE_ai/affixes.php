...
return [
    ...
    'explosive'                   => [
        'name'        => 'Explosiv',
        'description' => 'Während des Kampfes beschwören Feinde regelmäßig Explosivkugeln, die detonieren, wenn sie nicht zerstört werden.',
    ],
    'fortified'                   => [
        'name'        => 'Verstärkt',
        'description' => 'Nicht-Boss-Gegner haben 20% mehr Gesundheit und verursachen bis zu 20% mehr Schaden.',
    ],
    'grievous'                    => [
        'name'        => 'Schwerwiegend',
    ...
    'quaking'                     => [
        'name'        => 'Bebend',
        'description' => 'Regelmäßig senden alle Spieler eine Schockwelle aus, die Schaden zufügt und nahe Verbündete unterbricht.',
    ],
    'raging'                      => [
        'name'        => 'Wütend',
    ...
    'relentless'                  => [
        'name'        => 'Unerbittlich',
        'description' => 'Nicht-Boss-Gegner erhalten vorübergehend Immunität gegen Kontrollverlusteffekte.',
    ],
    'sanguine'                    => [
        'name'        => 'Blutig',
    ...
    'skittish'                    => [
        'name'        => 'Schüchtern',
        'description' => 'Feinde achten weit weniger auf die Bedrohung, die von Tanks erzeugt wird.',
    ],
    'teeming'                     => [
        'name'        => 'Wimmelnd',
    ...
    'spiteful'                    => [
        'name'        => 'Trotzig',
        'description' => 'Dämonen erheben sich aus den Leichen von Nicht-Boss-Gegnern und verfolgen zufällige Spieler.',
    ],
    'storming'                    => [
        'name'        => 'Stürmisch',
    ...
    'xalataths_bargain_ascendant' => [
        'name'        => 'Xal\'ataths Pakt: Aufgestiegen',
        'description' => 'Während des Kampfes lässt Xal\'atath Kugeln kosmischer Energie herabregnen, die Feinde oder Spieler stärken.',
    ],
    ...
    'xalataths_bargain_voidbound' => [
        'name'        => 'Xal\'ataths Handel: Leerengebunden',
        'description' => 'Während des Kampfes beschwört Xal\'atath einen Leerenemissär, der nahe Feinde stärkt.',
    ],
    ...
    'xalataths_guile'             => [
        'name'        => 'Xal\'ataths List',
        'description' => 'Xal\'atath verrät die Spieler, widerruft ihre Abmachungen, während Tode 15 Sekunden von der verbleibenden Zeit abziehen.',
    ],
    'challengers_peril'           => [
