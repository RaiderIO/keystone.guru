...
return [
    'dungeon'                    => [
        'edit' => [
            ...
            'facade_enabled'    => '@todo ru-RU: .dungeon.edit.facade_enabled',
            'id'                => '@todo ru-RU: .dungeon.edit.id',
            'game_version_id'   => '@todo ru-RU: .dungeon.edit.game_version_id',
            'zone_id'           => 'ID зоны',
            'map_id'            => '@todo ru: .dungeon.edit.map_id',
            'challenge_mode_id' => '@todo ru-RU: .dungeon.edit.challenge_mode_id',
            'mdt_id'            => 'MDT ID',
        ...
        'list' => [
            ...
            'table_header_game_version'         => '@todo ru-RU: .dungeon.list.table_header_game_version',
    ...
    'floor'                      => [
        ...
        'edit'    => [
            ...
            'active'                             => '@todo ru-RU: .floor.edit.active',
            'index'                              => 'Индекс',
            'mdt_sub_level'                      => 'MDT подуровень',
            'ui_map_id'                          => '@todo ru-RU: .floor.edit.ui_map_id',
            ...
            'enemy_engagement_max_range'         => '@todo ru-RU: .floor.edit.enemy_engagement_max_range',
            'enemy_engagement_max_range_patrols' => '@todo ru-RU: .floor.edit.enemy_engagement_max_range_patrols',
            ...
            'facade'                             => '@todo ru-RU: .floor.edit.facade',
            'facade_title'                       => '@todo ru-RU: .floor.edit.facade_title',
    ...
    'npc'                        => [
        ...
        'edit'  => [
            ...
            'scaled_health_percentage_placeholder' => '@todo ru-RU: .npc.edit.scaled_health_percentage_placeholder',
            ...
            'health_percentage'                    => '@todo ru-RU: .npc.edit.health_percentage',
            ...
            'sanguine'                             => 'Кровавый',
            'runs_away_in_fear'                    => '@todo ru-RU: .npc.edit.runs_away_in_fear',
    ...
    'npcenemyforces'             => [
        'title'                        => '@todo ru-RU: .npcenemyforces.title',
        'mapping_version_read_only'    => '@todo ru-RU: .npcenemyforces.mapping_version_read_only',
        'edit_enemy_forces'            => '@todo ru-RU: .npcenemyforces.edit_enemy_forces',
        'table_header_id'              => '@todo ru-RU: .npcenemyforces.table_header_id',
        'table_header_mapping_version' => '@todo ru-RU: .npcenemyforces.table_header_mapping_version',
        'table_header_enemy_forces'    => '@todo ru-RU: .npcenemyforces.table_header_enemy_forces',
        'table_header_actions'         => '@todo ru-RU: .npcenemyforces.table_header_actions',
        'edit'                         => [
            'title'                => '@todo ru-RU: .npcenemyforces.edit.title',
            'header'               => '@todo ru-RU: .npcenemyforces.edit.header',
            'enemy_forces'         => '@todo ru-RU: .npcenemyforces.edit.enemy_forces',
            'enemy_forces_teeming' => '@todo ru-RU: .npcenemyforces.edit.enemy_forces_teeming',
            'submit'               => '@todo ru-RU: .npcenemyforces.edit.submit',
        ],
    ],
    'release'                    => [
        'edit' => [
            ...
            'edit'         => 'Редактировать',
            'submit'       => 'Подтвердить',
            'release_json' => '@todo ru-RU: .release.edit.release_json',
        ],
        'list' => [
    ...
    'tools'                      => [
        ...
        'dungeonroute' => [
            ...
            'mappingversions' => [
                'title'                             => '@todo ru-RU: .tools.dungeonroute.mappingversions.title',
                'header'                            => '@todo ru-RU: .tools.dungeonroute.mappingversions.header',
                'table_header_mapping_version_name' => '@todo ru-RU: .tools.dungeonroute.mappingversions.table_header_mapping_version_name',
                'table_header_count'                => '@todo ru-RU: .tools.dungeonroute.mappingversions.table_header_count',
                'table_header_actions'              => '@todo ru-RU: .tools.dungeonroute.mappingversions.table_header_actions',
            ],
        ],
        'enemyforces'  => [
        ...
        'list'         => [
            ...
            'view_dungeonroute_mapping_version_usage' => '@todo ru-RU: .tools.list.view_dungeonroute_mapping_version_usage',
        ...
        'thumbnails'   => [
            'regenerate' => [
                ...
                'only_missing' => '@todo ru-RU: .tools.thumbnails.regenerate.only_missing',
