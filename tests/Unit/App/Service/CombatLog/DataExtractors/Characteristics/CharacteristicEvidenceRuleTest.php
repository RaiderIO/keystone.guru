...
final class CharacteristicEvidenceRuleTest extends PublicTestCase
{
    ...
    private const array CONCLUSIVE_SPELL_IDS = [
        ...
        45524, 47476, 49576, 56222, 61305, 61721, 62124, 64044, 89766, 102359, 111673, 115078,
        119381, 126819, 145532, 147732, 161353, 161354, 179057, 185245, 196840, 211881, 213691,
     ...
     * Garrote 703, Thunderstorm 51490), or the spell applies no aura to the NPC at all, so the aura seen
     * in the log belongs to a different spell id than the one curated (Typhoon 132469, Solar Beam 78675,
     * Crippling Poison 3408, Frostbolt 116).
     *
     * @var array<int, int>
     */
    private const array INCONCLUSIVE_SPELL_IDS = [
        116, 355, 703, 3408, 5782, 18100, 19577, 30108, 44614, 46968, 47481, 51490, 51533, 58180,
        78675, 103828, 107570, 108199, 115546, 115750, 115770, 116095, 132469, 187650, 191427,
        192058, 371032, 375058, 385952,
    ];
    ...
    #[Test]
    public function isConclusive_givenAKnockSpellApplyingItsAura_returnsFalse(): void
    {
        // Arrange - Thunderstorm knocks back and dazes; nothing about the daze says the knock landed
