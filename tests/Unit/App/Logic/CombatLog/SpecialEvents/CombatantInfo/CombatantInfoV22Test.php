...
class CombatantInfoV22Test extends PublicTestCase
{
    #[Test]
    #[Group('CombatLog')]
    #[Group('CombatantInfo')]
    ...
    public function parseEvent_GivenCombatantInfoEvent_ShouldValidateBasicStats(
        ...
        // Act
        /** @var CombatantInfoV22 $parseEventResult */
        $parseEventResult = $combatLogEntry->parseEvent();

        // Assert
        Assert::assertInstanceOf(CombatantInfoV22::class, $combatLogEntry->getParsedEvent());
        ...
        Assert::assertEquals($expectedUnknown1, $parseEventResult->getUnknown1());
