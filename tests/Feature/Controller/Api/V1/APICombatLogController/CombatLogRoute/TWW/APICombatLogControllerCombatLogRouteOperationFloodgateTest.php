...
class APICombatLogControllerCombatLogRouteOperationFloodgateTest extends APICombatLogControllerCombatLogRouteTestBase
{
    protected function getDungeonKey(): string
    {
        return DungeonKey::OPERATION_FLOODGATE->value;
    }
