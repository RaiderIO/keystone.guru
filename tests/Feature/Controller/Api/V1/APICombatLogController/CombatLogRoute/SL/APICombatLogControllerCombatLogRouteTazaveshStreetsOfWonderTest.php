...
class APICombatLogControllerCombatLogRouteTazaveshStreetsOfWonderTest extends APICombatLogControllerCombatLogRouteTestBase
{
    ...
    #[Test]
    public function create_givenTwwS3TazaveshStreetsOfWonder7Json_shouldReturnValidDungeonRoute(): void
    {
        // Arrange
        ...
        $this->validatePulls($responseArr, 21, 384);
