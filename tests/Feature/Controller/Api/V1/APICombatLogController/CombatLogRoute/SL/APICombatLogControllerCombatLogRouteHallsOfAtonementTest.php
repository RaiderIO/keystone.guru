...
class APICombatLogControllerCombatLogRouteHallsOfAtonementTest extends APICombatLogControllerCombatLogRouteTestBase
{
    protected function getDungeonKey(): string
    {
        return DungeonKey::HALLS_OF_ATONEMENT->value;
    }
    ...
    public function create_givenTwwS3HallsOfAtonement7Mv4Json_shouldReturnValidDungeonRoute(): void
    {
        ...
        $this->validatePulls($responseArr, 25, 575);
