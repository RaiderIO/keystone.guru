...
final class DungeonRouteDiscoverControllerTest extends PublicTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // The reworked leaderboard overview takes priority over the DungeonOverview landing page under
        // test here; keep it off so this suite is not at the mercy of the acting user's admin/role setup.
