...
use App\Http\Controllers\Ajax\AjaxEnemyForcesRegionController;
...
Route::middleware(['viewcachebuster', 'language', 'debugbarmessagelogger', 'read_only_mode', 'debug_info_context_logger', 'track_ip'])->group(static function () {
    ...
    Route::get('embed/heatmap/{gameVersion}/{dungeon}', new SiteController()->embedHeatmap(...))->name('misc.embed.heatmap');
    Route::get('embed/heatmap/{gameVersion}/{dungeon}/{floorIndex}', new SiteController()->embedHeatmap(...))->name('misc.embed.heatmap.floor');
        ...
        Route::middleware(['auth', 'role:admin'])->group(static function () {
            Route::prefix('admin')->group(static function () {
                ...
                Route::prefix('mappingVersion/{mappingVersion}')->group(static function () {
                    ...
                    Route::post('/enemyforcesregion', new AjaxEnemyForcesRegionController()->store(...))->name('ajax.admin.enemyforcesregion.create');
                    Route::put('/enemyforcesregion/{enemyForcesRegion}', new AjaxEnemyForcesRegionController()->store(...))->name('ajax.admin.enemyforcesregion.update');
                    Route::delete('/enemyforcesregion/{enemyForcesRegion}', new AjaxEnemyForcesRegionController()->delete(...))->name('ajax.admin.enemyforcesregion.delete');
