...
| showDataSourceSnackbar | **boolean**       | `1`                  | `0` or `1`. When `1`, the data source snackbar ("Showing data from <digit> runs") will be shown to the user. When `0` the data source snackbar will be hidden from view.                                                                                  |
