...
class AddFriendlyAggressivenessToNpcs extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        ...
        DB::statement("ALTER TABLE npcs CHANGE COLUMN aggressiveness aggressiveness ENUM('neutral', 'unfriendly', 'aggressive') NOT NULL DEFAULT 'aggressive'");
    }
}
