...
$jscomp.findInternal = function (a, h, f) {
    ...
    for (var e = a.length, l = 0; l < e; l++) {
        var m = a[l];
        if (h.call(f, m, l, a)) return {i: l, v: m}
    }
    return {i: -1, v: void 0}
};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfill = function (a, h, f, e) {
    if (h) {
        ...
        e = f[a];
        h = h(e);
        h != e && null != h && $jscomp.defineProperty(f, a, {configurable: !0, writable: !0, value: h})
    }
};
...
(function (a) {
    ...
    function f(b) {
        b = a(b);
        var c = b.find(".carousel-item").length, d = b.find(".carousel-inner").attr("data-visible");
        c < d && (d = c);
    ...
    a.fn.footerReveal = function () {
        function b() {
            !e && c.outerHeight() <= g.outerHeight() ? (c.css({
                ...
                position: "fixed",
                bottom: 0
            }), c.css({width: d.outerWidth()}), d.css({"margin-bottom": c.outerHeight()})) : (c.css({
                "z-index": "",
                position: "", bottom: ""
            }), c.css({width: ""}), d.css({"margin-bottom": ""}))
        }

        var c = a(this), d = c.prev(), g = a(window), e = !!document.documentMode;
        b();
    ...
    var l = function () {
        var b = a('<div style="height: 50vh; position: absolute; top: -1000px; left: -1000px;">').appendTo("body"),
            c = b[0], d = parseInt(window.innerHeight / 2, 10);
    ...
    a(function () {
        ...
        function c(b) {
            setTimeout(function () {
                a(b).outerFind(".mbr-parallax-background").jarallax({speed: .6}).css("position", "relative")
            }, 0)
        }
        ...
        function d(b) {
            a(b).outerFind("[data-bg-video]").each(function () {
                ...
                if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3]))) if (c && /youtu\.?be/g.test(c[3])) b = "http" + ("https:" === location.protocol ? "s" : "") + ":", b += "//img.youtube.com/vi/" + c[6] + "/maxresdefault.jpg", a("<img>").on("load", function () {
        ...
        var g, n, f = 0, k = null, h = !a.isMobile();
        a(window).scroll(function () {
            n && clearTimeout(n);
            var b = a(window).scrollTop(), c = b <=
                f || h;
            f = b;
            if (k) {
        ...
        a(document).on("add.cards delete.cards", function (b) {
            ...
            g = setTimeout(function () {
                    ...
                    a(".mbr-fixed-top:first").each(function () {
                        k = {breakPoint: a(this).offset().top + 3 * a(this).height(), fixed: !1, elm: this};
                        a(window).scroll()
                    })
                },
                650)
            ...
            function b() {
                ...
                if (n && g) {
                    ...
                    b > a && (a = 100 * (b - a) / a, d.css({
                        width: a +
                            100 + "%", maxWidth: a + 100 + "%", marginLeft: -a / 2 + "%"
                    }))
                }
            }

            var c = a(this), d = c.children("img"), e = c.parent(), g = d[0].width, n = d[0].height;
            d.one("load", function () {
                g = d[0].width;
                n = d[0].height;
                b()
            ...
            if (!a.isMobile() && a("input[name=animation]").length) {
                ...
                var d = a("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info").not(function () {
                    ...
                    return a(this).parents().is("form") &&
                        a(this).is("li")
                }).addClass("hidden animate__animated animate__delay-1s"), e = a(window);
                e.on("scroll resize", function () {
                    var e = document.documentElement.scrollTop || document.body.scrollTop,
                        g = e + window.innerHeight - 100;
                    a.each(d, function () {
                        var d = a(this), f = d[0], h = f.offsetHeight;
                        f = c(f);
    ...
    a(document).ready(function () {
        if (a(".mbr-arrow-up").length) {
            var b = a("#scrollToTop"), c = a("body,html"), d = a(window);
            b.css("display", "none");
            d.scroll(function () {
    ...
    a(document).ready(function () {
        if (!e) {
            var b = function (b) {
                var c = a(b).parents("section").find("iframe")[0], e = a(c).attr("src");
            ...
            a(".modalWindow-video iframe").each(function () {
                ...
                -1 !== b.indexOf("youtu") ? a(this).attr("src", "https://youtube.com/embed/" + d[6] + "?rel=0&enablejsapi=1") :
    ...
    e || ("undefined" === typeof window.initClientPlugin && 0 != a(document.body).find(".clients").length && (window.initClientPlugin = !0, a(document.body).find(".clients").each(function (b, c) {
        ...
        var b = a(this), c = b.find(".carousel-control"), d = b.find(".carousel-indicators li");
...
!function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobirise.in">Mobirise Easy Web Page Maker</a> Mobirise v5.2.0';
