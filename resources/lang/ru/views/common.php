...
return [
    ...
    'forms'        => [
        ...
        'createtemporaryroute' => [
            'unregistered_user_message' => 'Если вы незарегистрированный пользователь, все созданные вами маршруты будут временными, срок действия которых истечет через %d часов.',
        ...
        'mdtimport'            => [
            ...
            'unregistered_user_all_routes_temporary' => 'Так как вы незарегистрированный пользователь, все импортированные маршруты будут временными маршрутами, срок действия которых истечет через %s часов.',
