...
<div class="form-group">
    {{ __('MDT string importing is temporarily disabled while we work to restore the functionality for Shadowlands dungeons.') }}
    <br><br>
    {{ __('All MDT enemies need to be mapped 1:1 with Keystone.guru\'s enemies and I have not had the time yet to do it since MDT released their mapping, my apologies!') }}
