...
<div class="card-body">
    ...
    @guest
        <div class="form-group">
            {!! Form::label('enemy_report_username', __('view_common.modal.userreport.enemy.your_name')) !!}
            {!! Form::text('enemy_report_username', null, ['id' => 'enemy_report_username', 'class' => 'form-control']) !!}
        </div>
    @endguest
    <div class="form-group">
        {!! Form::label('enemy_report_message', __('view_common.modal.userreport.enemy.what_is_wrong')) !!}
        {!! Form::textarea('enemy_report_message', null, ['id' => 'enemy_report_message', 'class' => 'form-control', 'cols' => '50', 'rows' => '10']) !!}
    </div>

    <div class="form-group">
        @guest
            {!! Form::label('enemy_report_contact_ok', __('view_common.modal.userreport.enemy.contact_by_email_guest')) !!}
        @else
            {!! Form::label('enemy_report_contact_ok', __('view_common.modal.userreport.enemy.contact_by_email')) !!}
        @endguest
