...
<meta property="og:description"
      content="{{ $description . __('views/common.general.linkpreview.description_suffix') }}">
@isset($image)
...
<meta name="twitter:description"
      content="{{ $description . __('views/common.general.linkpreview.twitter_description_suffix')}}">
@isset($image)
