    ...
    <div class="row no-gutters py-2">
        ...
        <div class="col-auto px-0 px-md-1">
            ...
            @if($embedOptions['show']['floorSelection'])
                {{ html()->select('map_floor_selection_dropdown', [__('view_dungeon.explore.gameversion.embed.select_floor')], 1)->id('map_floor_selection_dropdown')->class('form-control selectpicker') }}
            @endif
        </div>
