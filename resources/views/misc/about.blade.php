...
@section('content')
    ...
    <p>
        ...
        making this website, and having a finished product that I can expand upon is great. I play on Lightbringer-EU - Horde
        as a Resto Druid in a fabulous casual guild called <a href="http://darkwolves.eu/">Dark Wolves</a> with my girlfriend and a
    ...
    <p>
        ...
        Together with guildies and friends, we poured ourselves on the dungeons and started whacking away. We weren't very
    ...
    <p>
        After that, I kind of lost steam and the project stalled for a month or two.  I had ideas, but I never made a real,
        ...
        at my place of employment which led me getting 10% of my work-time to work on projects that use technologies relevant
    ...
    <p>
        ...
        has a common understanding of what you're about to do. It can also help new players read up about what strategies
        people are currently using in dungeons (by means of popularity) so they can prepare themselves better. For now
        the website is fairly bare. You can select your dungeon, composition, and draw a path through the dungeon. I will
        expand on this in the near future. There were time constraints to consider and I can always expand on current functionality.
        If you don't think the website has enough features as of yet, please stay tuned! I'm dedicated to turning this website
        into a hub for sharing information and catering to increasingly hardcore players of the scene. For now it will fit
