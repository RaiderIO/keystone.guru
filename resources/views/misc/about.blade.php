@extends('layouts.sitepage', ['showLegalModal' => false, 'title' => __('view_misc.about.title')])

@section('header-title', __('view_misc.about.header'))
...
@section('content')
    ...
    <p>
        ...
        Horde
        as a Guardian Druid in a fabulous casual guild called <a href="https://www.darkwolves.eu/">Dark Wolves</a> with
        my
        girlfriend and a
