...
@section('content')
    <div class="container">
        ...
        <p>
            ...
            This makes mapping Infested enemies on Keystone.guru a challenge since valid data changes rapidly.
            Especially since I personally don't do 10+ keystones yet, and I want to keep focus on creating cool features
            for the website. To facilitate this, I have made a system that allows users of Keystone.guru to
            contribute to mapping Infested enemies as a community effort.
        </p>
        <h2>
        ...
        @guest
            <div class="alert alert-warning text-center">
                <i class="fa fa-exclamation-triangle"></i> You must be logged in to contribute to Infested mapping on
                Keystone.guru.
            </div>
            @endguest
            </p>
