...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            @endcomponent
            @component('common.dungeonroute.search.filter', ['key' => 'rating', 'text' => __('Minimum rating')])
            ...
            @component('common.dungeonroute.search.filter', ['key' => 'user', 'text' => __('User'), 'expanded' => false])
                {!! Form::text('user', request('user'), ['id' => 'title', 'class' => 'form-control', 'placeholder' => __('Filter by user')]) !!}
            @endcomponent
        </div>
        <div class="col-lg-9">
            <div id="route_list">
