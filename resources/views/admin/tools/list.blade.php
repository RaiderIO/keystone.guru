        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <a href="{{ route('admin.tools.combatlog.route.enemy_resolutions.view') }}">{{ __('view_admin.tools.list.combatlog_route_enemy_resolutions') }}</a>
                        <small class="text-muted d-block">{{ __('view_admin.tools.list.combatlog_route_enemy_resolutions_description') }}</small>
                    </li>
                </ul>
            </div>
        </div>
