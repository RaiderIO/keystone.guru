...
@section('content')
    ...
    <h4>{{ __('views/admin.tools.list.subheader_thumbnails') }}</h4>
    <div class="form-group">
        <a href="{{ route('admin.tools.thumbnails.regenerate.view') }}">{{ __('views/admin.tools.list.thumbnails_regenerate') }}</a>
    </div>
