...
@section('content')
    ...
    @isset($floor)
        <div class="form-group">
            @include('admin.floor.speedrunrequirednpcs', ['mode' => \App\Models\Speedrun\DungeonSpeedrunRequiredNpc::MODE_10_MAN, 'floor' => $floor])
        </div>
        <div class="form-group">
            @include('admin.floor.speedrunrequirednpcs', ['mode' => \App\Models\Speedrun\DungeonSpeedrunRequiredNpc::MODE_25_MAN, 'floor' => $floor])
        </div>
    @endisset
@endsection
