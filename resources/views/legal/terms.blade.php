@extends('layouts.sitepage', ['showLegalModal' => false, 'title' => __('view_legal.terms.title')])

@section('header-title', __('view_legal.terms.header'))

@section('content')
    <h5>Welcome to Keystone Guru</h5>
    <p>These terms and conditions outline the rules and regulations for the use of Keystone Guru's Website.</p>
    <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use
        Keystone Guru's website
    ...
    <h5>Cookies</h5>
    <p>We employ the use of cookies. By using Keystone Guru's website you consent to the use of cookies
        in accordance with Keystone Guru’s privacy policy.</p><p>Most of the modern day interactive web sites
        use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
        to enable the functionality of this area and ease of use for those people visiting. Some of our
        affiliate / advertising partners may also use cookies.</p><h5>License</h5>
    <p>Unless otherwise stated, Keystone Guru and/or it’s licensors own the intellectual property rights for
        all material on Keystone Guru. All intellectual property rights are reserved. You may view and/or print
        pages from https://keystone.guru for your own personal use subject to restrictions set in these terms and
        conditions.</p>
    <p>You must not:</p>
    <ol>
        <li>Republish material from https://keystone.guru</li>
        <li>Sell, rent or sub-license material from https://keystone.guru</li>
        <li>Reproduce, duplicate or copy material from https://keystone.guru</li>
    </ol>
    <p>Redistribute content from Keystone Guru (unless content is specifically made for redistribution).</p>
    <h5>User Comments</h5>
    <ol>
        <li>This Agreement shall begin on the date hereof.</li>
        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
            material and data ('Comments') in areas of the website. Keystone Guru does not screen, edit, publish
            or review Comments prior to their appearance on the website and Comments do not reflect the views or
            opinions ofKeystone Guru, its agents or affiliates. Comments reflect the view and opinion of the
            person who posts such view or opinion. To the extent permitted by applicable laws Keystone Guru shall
        ...
        <li>Keystone Guru reserves the right to monitor all Comments and to remove any Comments which it considers
        ...
        <li>You hereby grant to <strong>Keystone Guru</strong> a non-exclusive royalty-free license to use, reproduce,
    ...
    <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
        ...
        the visibility associated with the hyperlink outweighs the absence of Keystone Guru and (d) where the
    ...
    <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
        you must notify us by sending an e-mail to <a href="mailto:support@keystone.guru"
                                                      title="send an email to support@keystone.guru">support@keystone.guru</a>.
    ...
    <p>No use of Keystone Guru’s logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>
