...
return [
    ...
    /** Recording and display of how far the Auto Route Creator's successful enemy matches were off */
    'enemy_resolution' => [
        /** Only matches at least this many ingame yards off are recorded; measured over real runs, the median match is 12.7 and p90 38.0 yards off */
    ...
    'thumbnail' => [
        ...
        /**
         * The amount of days without an edit or a display after which the hourly sweep deletes a route's standard and
         * front page thumbnails. The next display renders them again.
         */
        'expire_inactive_days' => 90,

        /**
         * The maximum amount of routes the hourly sweep expires in a single run, so a large backlog is worked off gradually.
         */
    ...
    'discover' => [
        ...
        'limits' => [
            ...
            'affix_overview' => 12,
            'per_dungeon'    => 8,
            /** Routes per page on the dungeon leaderboard */
            'leaderboard' => 18,
        ],
